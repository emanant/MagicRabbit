...
fs.writeFileSync(path.join(__dirname, "./../content.yaml"), YAML.stringify(finalContent));
fs.writeFileSync(path.join(__dirname, "./../content.json"), JSON.stringify(finalContent, null, 4));
