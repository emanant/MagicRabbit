 ...
 * The FlaxDisplay object contains main screen of MagicRabbit. It does not contain Character.
 */
export default class Game implements IGame {
	 ...
	 */
	constructor() {
		this.exerciseMain = DisplayCache.getCreateDisplay(Resources.imageRes.BUZHC_plist, "Exercise_MC");
	}
}
